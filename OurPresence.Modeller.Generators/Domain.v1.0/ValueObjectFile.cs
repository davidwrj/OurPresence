...
namespace DomainProject
{
    internal class ValueObjectFile : IGenerator
    {
        ...
        public IOutput Create()
        {
            ...
            sb.I(2).Al("{");
            sb.I(3).Al("return obj is T valueObject && ValueObject.GetUnproxiedType(this) == ValueObject.GetUnproxiedType(obj) && EqualsCore(valueObject);");
            sb.I(2).Al("}");
            sb.B();
            ...
            sb.I(2).Al("{");
            sb.I(3).Al("return a is null && b is null || a is not null && b is not null && a.Equals(b);");
            sb.I(2).Al("}");
            sb.B();
            sb.I(2).Al("public static bool operator !=(ValueObject<T> a, ValueObject<T> b)");
            sb.I(2).Al("{");
